...
public class GameAPI : MonoBehaviour
{
    ...
    public IEnumerator GetHighScore(Action<int> onSuccess, Action<string> onError)
    {
        ...
        string url = $"https://localhost:7174/api/history/history/get-high-score?userId={userId}&gameId={gameId}";
    ...
    public IEnumerator PostPlayHistory(int finalScore, Action onSuccess, Action<string> onError)
    {
        ...
        UnityWebRequest request = new UnityWebRequest("https://localhost:7174/api/history/history/new-play-history", "POST");
